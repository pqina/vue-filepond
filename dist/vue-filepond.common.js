...
var isSupported = Object(external_filepond_["supported"])(); // Setup initial prop types and update when plugins are added
...
var lib_props = {}; // Events that need to be mapped to emitters
...
/* harmony default export */ var lib = (function () {
  // register plugins in FilePond
  external_filepond_["registerPlugin"].apply(void 0, arguments); // build events and props array

  events.length = 0;

  for (var prop in external_filepond_["OptionTypes"]) {
  ...
  return Object(external_vue_["defineComponent"])({
    ...
    setup: function setup(props, _ref) {
      var emit = _ref.emit,
          attrs = _ref.attrs;
      var root = Object(external_vue_["ref"])(null);
      var pond = null; // Will setup FilePond instance when mounted

      Object(external_vue_["onMounted"])(function () {
        // exit here if not supported
        if (!isSupported) return; // get pond element

        var element = root.value.querySelector('input'); // Map FilePond callback methods to Vue $emitters

        var methods = events.reduce(function (obj, value) {
          obj[value] = function () {
            ...
            emit.apply(void 0, [value.substr(2)].concat(args));
          };

          return obj;
        }, {});
        var options = Object(external_filepond_["getOptions"])();
        var userProps = {};

        for (var _prop in props) {
          if (props[_prop] !== '__undefined__') {
            userProps[_prop] = props[_prop];
          }
        }
        ...
        for (var attr in attrs) {
          var name = attr.toLocaleLowerCase();
        ...
        var filePondOptions = _objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2({}, globalOptions), methods), options), userProps), userAttrs); // Create our pond


        pond = Object(external_filepond_["create"])(element, filePondOptions); // Copy instance method references to component instance

        Object.keys(pond).filter(function (key) {
          return !filteredComponentMethods.includes(key);
        }).forEach(function (key) {
          return root.value[key] = pond[key];
      ...
      var detached = function detached() {
        ...
        var index = instances.indexOf(pond.value);
...
/******/ })["default"];
//# sourceMappingURL=vue-filepond.common.js.map