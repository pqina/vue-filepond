  ...
  return {
    ...
    render() {
      return h(
        ...
        [
          h("input", {
            id: this.passedProps.id,
            name: this.passedProps.name,
            type: "file",
            class: this.passedProps.className,
            required: this.passedProps.required,
            multiple: this.passedProps.allowMultiple,
            accept: this.passedProps.acceptedFileTypes,
            capture: this.passedProps.captureMethod,
          }),
        ]
      );
    },
    ...
    mounted() {
      ...
      this._pond = create(
        this._element,
        Object.assign({}, globalOptions, options, this.passedProps)
      );
